package com.github.splatch.iconify;
...
import com.github.splatch.iconify.descriptor.Collection;
import com.github.splatch.iconify.descriptor.IconifyIcon;
import com.github.splatch.iconify.descriptor.IconifyIconSet;
    ...
    for (Entry<String, Collection> entry : collections.entrySet()) {
      ...
      if ("general".equalsIgnoreCase(collection.getCategory()) && "Apache-2.0".equals(collection.getLicense().getSpdx())) {
        ...
        for (Entry<String, IconifyIcon> icons : iconSet.getIcons().entrySet()) {
          ...
          File iconFile = new File("target/classes/icons/" + iconSetId + "/" + iconId + ".svg");
